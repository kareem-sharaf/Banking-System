...
@Component
@Slf4j
public class InvestmentInterestStrategy implements InterestCalculationStrategy {
    ...
    public BigDecimal calculateInterest(Account account, LocalDate calculationDate) {
        ...
        if (balance.compareTo(BigDecimal.ZERO) <= 0) {
            log.debug("Investment account {} has zero or negative balance, skipping interest calculation",
        ...
        if (annualRate == null || annualRate.compareTo(BigDecimal.ZERO) <= 0) {
            ...
            log.debug("Using default investment interest rate {} for account {}",
        ...
        log.debug("Calculated interest for investment account {}: {} (Balance: {}, Rate: {})",
    ...
    public boolean supports(AccountType accountType) {
        ...
        return "INVESTMENT".equalsIgnoreCase(accountType.getCode());
    }

    @Override
    public String getStrategyName() {
        return "InvestmentInterestStrategy";
    }
